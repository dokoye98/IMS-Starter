...
public enum Domain {
	...
	CLIENT("Information about customers"), ITEM("Individual Items"), ORDER("Purchases of items"),
	PRODUCT("To add product to lorry delivery"), STOP("To close the application"), ;
